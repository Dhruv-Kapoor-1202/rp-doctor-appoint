...
const ContactSection = () => {
  return (
    <section className="container grid max-w-screen-xl grid-cols-1 gap-4 p-2 py-8 mx-auto sm:py-12 md:grid-cols-2">
      <div className="flex flex-col ">
        ...
        <div className="flex items-center gap-2 italic font-medium tracking-normal text-base/7 text-balance">
          <p>Follow Us: </p>
          <Linkedin className="size-5 hover:scale-[1.1] duration-200 cursor-pointer" />
          <Twitter className="size-5 hover:scale-[1.1] duration-200 cursor-pointer" />
          <Twitch className="size-5 hover:scale-[1.1] duration-200 cursor-pointer" />
        </div>
      </div>
